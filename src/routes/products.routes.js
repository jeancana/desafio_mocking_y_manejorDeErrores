...
router.get("/mockingproduct/:qty", async (req, res) => {
...
router.post('/', passportCall('jwtAuth', { session: false }), authorizationMid('admin'),async (req, res) => {
...
router.delete("/:pid", passportCall('jwtAuth', { session: false }), authorizationMid('admin'),
    uploader.single('thumbnail'), async (req, res) => {
