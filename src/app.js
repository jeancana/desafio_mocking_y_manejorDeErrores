...
try {
    ...
    // 21) GESTOR CENTRAL DE ERRORES - Middleware de captura general de errores
  ...
  /*   app.use((err, req, res, next) => {
    ...
    // 22) Esta es una respuesta Generica GLOBAL en caso de que no exista NINGUNA respuesta en alguna Ruta
